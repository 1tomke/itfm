    ...
    <div className='flex flex-col fixed w-full h-full'>
      ...
      <div className='flex h-full w-full'>
        ...
        <div className='h-full w-1/2 flex justify-center items-center'>
            <form onSubmit={handleSubmit} className='pb-48 flex flex-col'>
              ...
              <div className='mt-5'>
                <label for="help" className='label'>How can we help you?</label>
                <div className='border-2 rounded'>
                 <textarea name="help" rows="4" className='block w-full'></textarea>
                </div>
              </div>
              <div className='flex justify-end pt-4'>
                <button type='submit' className='bg-blue-400 text-white py-2 px-3 rounded-lg text-sm font-semibold'>
                  Send message
                </button>
              </div>
            </form>
